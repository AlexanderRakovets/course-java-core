...
class Task03 {
    ...
    static int calculateHealthPointsByTime(int healthPoints, double regenerationPercentFromCurrentHealth, int hoursAfterRespawn) {
        ...
        double regenerationBossHealthPointsOverTime = healthPoints;
        for (int i = 0; i < hoursAfterRespawn ; i++) {
            regenerationBossHealthPointsOverTime += regenerationBossHealthPointsOverTime * regenerationPercentFromCurrentHealth / 100;
        }
        return (int) regenerationBossHealthPointsOverTime;
    }
}
